...
const Header = () => (
  <div className="app__header app__wrapper section__padding" id="home">
    <div className="app__wrapper_info">
      <SubHeading style={{fontFamily:'Open Sans, sans-serif'}}title="ಚಹಾ - ಭರವಸೆಗಳ ದಾರಿಯಲ್ಲಿ ಒಂದು ಸಣ್ಣ ವಿರಾಮ" />
      <h1 className="app__header-h1" style={{fontFamily:'Open Sans, sans-serif'}}>CAFE UNNATI</h1>
